task preprocess {
    ...
    command <<<
	    ...
	    cat "${summary_file}" | \
            ...
            pheweb format-summary-file ${chrom_flag} ${pos_flag} ${ref_flag} ${alt_flag} ${pval_flag} ${mlogp_flag} ${beta_flag} ${se_beta_flag} ${exclude_flag} ${rename_flag} | \
...
task annotation {
    ...
    command <<<
        ...
        # Seems like have to move the files to the cache for pheweb to find them
        [[ -z "${rsids_file}" ]] || mv ${rsids_file} /root/.pheweb/cache/rsids-b38-dbsnp151.vcf.gz
        ...
        for url in ${sep="\t" output_url}; do
            ...
            /pheweb/scripts/copy_files.sh /root/.pheweb/cache/genes-b38-v37.bed                            $url/cache/genes-b38-v37.bed
        done
